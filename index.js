...
//use verify admin after verifyToken
  const verifyAdmin= async(req,res,next)=>{
    ...
    app.post("/users", async(req,res)=>{
      ...
      // you can do this in many ways(1.unique email, 2.upsert, 3.simple checking in data base)
    ...
    //secure koraw jay abar naw kora jay:
...
//------------------------------------
  ...
  //--------------------------------------------------------------------------
  // => Revenue System: This is not a best way
